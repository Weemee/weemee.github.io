(window.webpackJsonp = window.webpackJsonp || []).push([
	[0],
	{
		...
		715: function (e, t, i) {
			...
			const O = { loggedIn: !1 };
			var v = function (e = O, t) {
				switch (t.type) {
					case 'LOGIN':
						return m(m({}, e), {}, { loggedIn: !0 });
					case 'LOGOUT':
						return m(m({}, e), {}, { loggedIn: !1 });
				}
				return e;
			};
			...
			const M = Object(W.a)(L.a)({
					...
					'&:hover': { backgroundColor: '#fff', borderColor: '#8c3562', color: '#8c3562', boxShadow: 'none' },
					'&:active': {},
					'&:focus': {},
				}),
				E = Object(W.a)(L.a)({
					...
					'&:hover': { backgroundColor: '#8c3562', boxShadow: 'none' },
					'&:active': {},
					'&:focus': {},
				});
			var F = i(723),
									...
									children: [
										...
										Object(H.jsx)('div', {
											...
											children: Object(H.jsx)(E, {
												...
												variant: 'contained',
												disableRipple: !0,
												sx: { textTransform: 'uppercase', width: 350, height: 70, fontSize: 20 },
			...
			const he = Object(F.a)(() => ({
					...
					timeArea: { flex: 0.77, display: 'flex', flexDirection: 'column' },
					timeOptions: {
						display: 'flex',
						justifyContent: 'space-between',
						paddingBottom: 17,
					...
					header: { background: '#003451', color: 'white', width: '100%', padding: 8, height: 19 },
					headerDays: { textAlign: 'center', flex: 1 / 7 },
					timeBody: {},
					slidePicker: { width: '100%', flex: 0.27, textTransform: 'uppercase', paddingBottom: 17 },
					select: { background: 'white', borderRadius: '12px !important' },
					timeRow: { width: '100%', display: 'flex', position: 'relative' },
					timeCol: {
						flex: 1 / 7,
						height: 140,
						backgroundColor: '#fff',
					...
					textFieldRoot: {
						...
						'& .MuiInputBase-input': { padding: '7px 14px' },
					},
					disabledButton: {
						backgroundColor: '#e5b3cd !important',
						color: '#fff !important',
							...
							Ve = (e, t) => {
								const i = 11 + 2 * t,
									n = {
										fullDate: e,
										teacher: e.teacher,
										date: `${e.year}-${e.month + 1 < 10 ? '0' : ''}${e.month + 1}-${e.date < 10 ? '0' : ''}${
											e.date
										}`,
										time: `${i}:00 - ${i}:45`,
									};
														...
														return Object(H.jsx)(
															'div',
															{
																...
																style: {
																	...
																	borderLeft: n > 0 ? '1px solid black' : 'none',
																	borderRadius: 0,
																	cursor: 'default',
																	borderBottom: 'none',
																	borderTop: 'none',
																...
																children: Object(H.jsx)('div', {
																	...
																	children: x ? x === r.teacher.name && He(r, i) : He(r, i),
																}),
															},
															Date.now() + i + n,
														);
																...
																Object(H.jsxs)('div', {
																	...
																	children: [
																		...
																		Object(H.jsx)('div', {
																			...
																			style: {
																				background: 'weekly' === o ? '#003451' : '#dedede',
																				color: 'weekly' === o ? 'white' : 'black',
																				padding: '6px 20px',
																				cursor: 'pointer',
																				flex: 0.5,
																			},
				...
				Ct = [
					{
						id: 1,
						name: 'Lars-Åke',
						messages: [{ id: 1, time: '04:03', text: 'Det blir bra det!' }],
						imagePath: './images/person_1.avif',
					},
					{
						id: 2,
						name: 'Sven-Lasse',
						messages: [{ id: 1, time: '11:23', text: 'Vi kanske kan ändra tiden?' }],
						imagePath: './images/person_2.avif',
					},
					{
						id: 3,
						name: 'Gun-Britt',
						messages: [{ id: 1, time: '13:37', text: 'Jag ser fram emot det! :)' }],
