(window.webpackJsonp = window.webpackJsonp || []).push([
	[0],
	{
		...
		284: function (e, t, i) {
			i(285), i(636), (e.exports = i(268));
		},
		628: function (e, t) {},
		630: function (e, t) {},
		632: function (e, t, i) {
			(e.exports = i(633)(!1)).push([
				e.i,
		...
		636: function (e, t, i) {
			...
			function j(e) {
				for (var t = 1; t < arguments.length; t++) {
					var i = null != arguments[t] ? arguments[t] : {};
					t % 2
						? x(Object(i), !0).forEach(function (t) {
								v(e, t, i[t]);
						  })
						: Object.getOwnPropertyDescriptors
						? Object.defineProperties(e, Object.getOwnPropertyDescriptors(i))
			...
			const O = { loggedIn: !1 };
			var y = function (e = O, t) {
				switch (t.type) {
					case 'LOGIN':
						return j(j({}, e), {}, { loggedIn: !0 });
					case 'LOGOUT':
						return j(j({}, e), {}, { loggedIn: !1 });
				}
				return e;
			};
			var w = (e) => Object(l.c)({ account: y, app: g, router: Object(b.b)(e) }),
				k = i(131),
				N = i(10);
			function C() {
			...
			const M = Object(L.a)(() => ({
				...
				middleBox: { flex: 0.3, display: 'flex', background: E, flexDirection: 'column', padding: 20 },
						...
						return Object(H.jsxs)('div', {
							...
							children: [
								...
								Object(H.jsxs)('div', {
									...
									children: [
										Object(H.jsx)('div', { style: { flex: 0.4, height: 220, backgroundColor: E } }),
										Object(H.jsxs)('div', {
				...
				return (
					...
					(function (e, t) {
						...
						var r,
							...
							s = !1;
						try {
							for (i = i.call(e); !(a = (r = i.next()).done) && (n.push(r.value), !t || n.length !== t); a = !0);
						} catch (e) {
							(s = !0), (o = e);
						} finally {
							try {
			...
			const Q = Object(L.a)(() => ({
					...
					timeArea: { flex: 0.7, display: 'flex', flexDirection: 'column' },
					timeOptions: { display: 'flex', justifyContent: 'space-between', paddingBottom: 17 },
					timeSection: {
						width: '100%',
						height: '100%',
						background: '#c9c9c9',
					...
					header: { background: '#777', color: 'white', width: '100%', padding: 8, height: 19 },
					timeBody: {},
					slidePicker: { width: '100%', flex: 0.27, textTransform: 'uppercase', paddingBottom: 17 },
					select: { background: 'white', borderRadius: 17 },
				})),
				X = [
					{ id: 1, name: 'Borlänge' },
					{ id: 2, name: 'Falun' },
				...
				ee = { PaperProps: { style: { maxHeight: 224, width: 250 } } };
			var te = Object(k.c)(
					Object(s.c)(
						function (e) {
							return {};
						...
						const t = Q(),
							i = Object(U.a)(),
							o = $(Object(r.useState)('monthly'), 2),
							n = o[0],
							a = o[1],
							s = $(Object(r.useState)(''), 2),
							l = s[0],
							c = s[1],
							d = $(Object(r.useState)(''), 2),
							b = d[0],
							p = d[1],
							h = $(Object(r.useState)(''), 2),
							u = h[0],
							m = h[1];
						return Object(H.jsxs)('div', {
							className: t.root,
									...
									children: [
										Object(H.jsxs)('div', {
											...
											children: [
												...
												Object(H.jsxs)('div', {
													style: { flex: 1, padding: 17, display: 'flex', flexDirection: 'column' },
													children: [
														Object(H.jsx)('div', {
															...
															children: Object(H.jsxs)(F.a, {
																fullWidth: !0,
																children: [
																	Object(H.jsx)(V.a, { children: 'Ort' }),
																	Object(H.jsx)(J.a, {
																		value: l,
																		label: 'Ort',
																		onChange: (e) => c(e.target.value),
																		className: t.select,
																		input: Object(H.jsx)(K.a, { label: 'Name' }),
																		MenuProps: ee,
																		children: X.map((e) =>
																			Object(H.jsx)(
																				q.a,
																				{ value: e.name, style: Z(e.name, l, i), children: e.name },
																				e.id,
																			),
																		),
																	}),
														...
														l.length > 0 &&
															Object(H.jsx)('div', {
																...
																children: Object(H.jsxs)(F.a, {
																	fullWidth: !0,
																	children: [
																		Object(H.jsx)(V.a, { children: 'Dans' }),
																		Object(H.jsx)(J.a, {
																			value: b,
																			label: 'Dans',
														...
														b.length > 0 &&
															Object(H.jsx)('div', {
																...
																children: Object(H.jsxs)(F.a, {
																	fullWidth: !0,
																	children: [
																		Object(H.jsx)(V.a, { children: 'Tränare' }),
																		Object(H.jsxs)(J.a, {
																			value: u,
																			label: 'Tränare',
																			...
																			className: t.select,
																			children: [
																				Object(H.jsx)(q.a, { value: 10, children: 'Sven-Lasse' }),
																				Object(H.jsx)(q.a, { value: 20, children: 'Bengt-Göran' }),
																				Object(H.jsx)(q.a, { value: 30, children: 'Lars-Åke' }),
																			],
																		}),
																	],
																}),
										...
										u &&
											Object(H.jsx)('div', {
												style: { flex: 0.3, background: '#c9c9c9', borderRadius: 12, overflow: 'hidden' },
												children: 'Bot area',
											}),
									],
								}),
									...
									Object(H.jsxs)('div', {
										...
										children: [
												...
												children: Object(H.jsxs)('div', {
													...
													children: [
														Object(H.jsx)('div', {
															onClick: () => a('monthly'),
															style: {
																background: 'monthly' === n ? '#777' : '#c9c9c9',
																color: 'monthly' === n ? 'white' : 'black',
																padding: '6px 20px',
																cursor: 'pointer',
																flex: 0.5,
															},
														...
														Object(H.jsx)('div', {
															onClick: () => a('weekly'),
															style: {
																background: 'weekly' === n ? '#777' : '#c9c9c9',
																color: 'weekly' === n ? 'white' : 'black',
																padding: '6px 20px',
																cursor: 'pointer',
																flex: 0.5,
															},
											...
											Object(H.jsxs)('div', {
												...
												children: [
													Object(H.jsx)('div', { className: t.header }),
													Object(H.jsx)('div', { className: t.timeBody }),
												],
											}),
										],
									}),
			...
			function ne(e, t) {
				return (
					...
					(function (e, t) {
						...
						'Object' === i && e.constructor && (i = e.constructor.name);
						if ('Map' === i || 'Set' === i) return Array.from(e);
						if ('Arguments' === i || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(i)) return ae(e, t);
					})(e, t) ||
					(function () {
						throw new TypeError(
							'Invalid attempt to destructure non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method.',
			...
			const se = Object(ie.a)(W.a)({
				...
				le = Object(L.a)(() => ({
					...
					mainContent: { width: '80vw', paddingTop: 20 },
					header: {
						height: 102,
						display: 'flex',
						justifyContent: 'space-between',
					...
					menuActive: {
						color: I + ' !important',
						borderBottom: `2px solid ${I} !important`,
				...
				ce = Object(re.a)({ props: { MuiButtonBase: { disableRipple: !0 } } });
			var de = Object(k.c)(
					Object(s.c)(
						function (e) {
						...
						function (e) {
							return Object(l.b)({ login: C, logout: S }, e);
						},
					)((e) => {
						const t = le(),
							i = ne(Object(r.useState)('home'), 2),
							o = i[0],
							n = i[1],
							a = ne(Object(r.useState)(!1), 2),
							s = a[0],
							l = a[1];
						return Object(H.jsx)(oe.a, {
							theme: ce,
							children: Object(H.jsxs)('div', {
								className: t.root,
								children: [
									e.loggedIn &&
										Object(H.jsxs)('div', {
											className: Object(N.a)(t.chatArea, { [t.chatOpen]: s }),
											children: [
												Object(H.jsx)('div', {
													onClick: () => l(!s),
													style: {
									...
									Object(H.jsxs)('div', {
										...
										children: [
														...
														children: [
															Object(H.jsx)('div', {
																children: Object(H.jsx)(se, {
																	...
																	variant: 'text',
																	onClick: () => n('home'),
																	className: Object(N.a)(t.menuItem, { [t.menuActive]: 'home' === o }),
																	children: 'Start',
																}),
															}),
															Object(H.jsx)('div', {
																children: Object(H.jsx)(se, {
																	...
																	variant: 'text',
																	onClick: () => n('book'),
																	className: Object(N.a)(t.menuItem, { [t.menuActive]: 'book' === o }),
																	children: 'Boka',
																}),
															}),
															Object(H.jsx)('div', {
																children: Object(H.jsx)(se, {
																	...
																	variant: 'text',
																	onClick: () => n('price'),
																	className: Object(N.a)(t.menuItem, {
															...
															Object(H.jsx)('div', {
																children: Object(H.jsx)(se, {
																	disableRipple: !0,
																	variant: 'text',
																	onClick: () => (e.loggedIn ? e.logout() : e.login()),
																	className: Object(N.a)(t.menuItem, {
																		[t.menuActive]: 'login' === o,
																	}),
																	children: e.loggedIn ? 'Logga ut' : 'Logga in',
																}),
															}),
														],
													}),
											...
											(() => {
												switch (o) {
													case 'home':
														return Object(H.jsx)(G, { onNav: (e) => n(e) });
													case 'book':
			...
			function* pe() {}
			function* he() {
				yield Object(be.b)('@@router/LOCATION_CHANGE', pe);
			}
			var ue = function* () {
				yield Object(be.a)([he()]);
			};
			...
			const ge = Object(p.a)(),
				...
				je = Object(c.a)();
			let ve;
			ve = Object(l.a)(je, xe)(l.d)(w(ge));
			je.run(ue),
				a.a.render(
					Object(H.jsx)(fe, {
						children: Object(H.jsx)(s.a, {
							store: ve,
							children: Object(H.jsx)(b.a, { history: ge, children: Object(H.jsx)(de, {}) }),
						}),
					}),
